...
Looks at three things: structural integrity (shape, nulls, duplicates), whether
the features carry any signal about the targets (Pearson correlation, one-way
ANOVA, mutual information), and whether Sales_Classification is just a threshold
on Sales_Volume (target leakage).
