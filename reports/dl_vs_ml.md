...
| Model | R² | RMSE | MAE |
|---|---|---|---|
| Tabular MLP (PyTorch) | -0.0037 | 2863.2 | 2478.6 |
| Best gradient booster | -0.0017 | - | - |

### Classification - `Sales_Classification` (higher ROC-AUC is better)

| Model | ROC-AUC | Accuracy | F1 |
|---|---|---|---|
| Tabular MLP (PyTorch) | 0.4932 | 0.6951 | 0.0000 |
| Best gradient booster | 0.5073 | - | - |

- MLP size: 15,105 parameters · early-stopped after 9 (reg) / 13 (clf) epochs.
